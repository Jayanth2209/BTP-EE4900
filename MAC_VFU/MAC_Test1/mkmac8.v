...
//
// On Mon Mar 27 20:29:10 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
// CLK                            I     1 clock
// RST_N                          I     1 reset
// get_values_multiplicand1       I     8
// get_values_multiplicand2       I     8
// get_values_addend              I     8
// EN_get_values                  I     1
//
...
module mkmac8(CLK,
  ...
  begin
    if (RST_N == `BSV_RESET_VALUE)
      begin
        a <= `BSV_ASSIGNMENT_DELAY 8'd0;
	inp_ready <= `BSV_ASSIGNMENT_DELAY 1'd0;
	m1 <= `BSV_ASSIGNMENT_DELAY 8'd0;
	m2 <= `BSV_ASSIGNMENT_DELAY 8'd0;
	mac_ready <= `BSV_ASSIGNMENT_DELAY 1'd0;
	resmac <= `BSV_ASSIGNMENT_DELAY 16'd0;
      end
    else
      begin
