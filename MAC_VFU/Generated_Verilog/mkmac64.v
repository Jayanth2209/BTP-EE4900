...
//
// On Sun Mar 26 18:29:16 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkmac64(CLK,
  ...
  wire CAN_FIRE_RL_compute_mac64,
       CAN_FIRE_get_values,
       WILL_FIRE_RL_compute_mac64,
       WILL_FIRE_get_values;

  // remaining internal signals
  wire [255 : 0] SEXT_m1_MUL_SEXT_m2___d7;
  wire [127 : 0] x__h250, y__h249, y__h251;
  ...
  // rule RL_compute_mac64
  assign CAN_FIRE_RL_compute_mac64 = isReady == 2'd1 ;
  assign WILL_FIRE_RL_compute_mac64 = CAN_FIRE_RL_compute_mac64 ;
  ...
  assign isReady$EN = EN_get_values || WILL_FIRE_RL_compute_mac64 ;
  ...
  // register resmac
  assign resmac$D_IN = SEXT_m1_MUL_SEXT_m2___d7[127:0] + y__h249 ;
  assign resmac$EN = CAN_FIRE_RL_compute_mac64 ;

  // remaining internal signals
  assign SEXT_m1_MUL_SEXT_m2___d7 = x__h250 * y__h251 ;
  assign x__h250 = { {64{m1[63]}}, m1 } ;
  assign y__h249 = { {64{a[63]}}, a } ;
  assign y__h251 = { {64{m2[63]}}, m2 } ;
