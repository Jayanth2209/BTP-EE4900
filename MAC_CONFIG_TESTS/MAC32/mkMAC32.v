...
//
// On Thu May  4 23:32:39 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkMAC32(CLK,
  ...
  assign CAN_FIRE_RL_rl_add_partials =
	     partial_product_rv[160] && !mac_output_rv[64] ;
  ...
  assign mac_output_rv$port1__write_1 = { 1'd1, x__h1273 + y__h1274 } ;
  ...
  assign _0_CONCAT_mac_inputs_rv_port0__read_BITS_95_TO__ETC___d21 =
	     { 16'd0, mac_inputs_rv[95:80] } *
	     { 16'd0, mac_inputs_rv[63:48] } ;
  assign x__h1273 = x__h1275 + y__h1276 ;
  assign x__h1275 = x__h1277 + y__h1278 ;
  assign x__h1277 = { 32'd0, partial_product_rv[159:128] } ;
  assign x__h1348 = partial_product_rv[127:96] + partial_product_rv[95:64] ;
  assign y__h1274 = { 32'd0, partial_product_rv[31:0] } ;
  assign y__h1276 = { partial_product_rv[63:32], 32'd0 } ;
  assign y__h1278 = { 16'd0, x__h1348, 16'd0 } ;
