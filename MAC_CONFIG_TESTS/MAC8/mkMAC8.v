...
//
// On Fri May  5 01:11:19 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
module mkMAC8(CLK,
  ...
  wire [31 : 0] _0_CONCAT_mac_inputs_rv_port0__read_BITS_71_TO__ETC___d38,
		_0_CONCAT_mac_inputs_rv_port0__read_BITS_79_TO__ETC___d29,
		_0_CONCAT_mac_inputs_rv_port0__read_BITS_87_TO__ETC___d20,
		_0_CONCAT_mac_inputs_rv_port0__read_BITS_95_TO__ETC___d11;
  wire [15 : 0] mac0__h539,
		mac1__h540,
		mac2__h541,
		mac3__h542,
		x__h563,
  ...
  assign mac_output_rv$port1__write_1 =
	     { 1'd1, mac3__h542, mac2__h541, mac1__h540, mac0__h539 } ;
  ...
  // remaining internal signals
  assign _0_CONCAT_mac_inputs_rv_port0__read_BITS_71_TO__ETC___d38 =
	     x__h907 * y__h908 ;
  assign _0_CONCAT_mac_inputs_rv_port0__read_BITS_79_TO__ETC___d29 =
	     x__h820 * y__h821 ;
  assign _0_CONCAT_mac_inputs_rv_port0__read_BITS_87_TO__ETC___d20 =
	     x__h733 * y__h734 ;
  assign _0_CONCAT_mac_inputs_rv_port0__read_BITS_95_TO__ETC___d11 =
	     x__h563 * y__h564 ;
  assign mac0__h539 =
	     _0_CONCAT_mac_inputs_rv_port0__read_BITS_71_TO__ETC___d38[15:0] +
	     y__h906 ;
  assign mac1__h540 =
	     _0_CONCAT_mac_inputs_rv_port0__read_BITS_79_TO__ETC___d29[15:0] +
	     y__h819 ;
  assign mac2__h541 =
	     _0_CONCAT_mac_inputs_rv_port0__read_BITS_87_TO__ETC___d20[15:0] +
	     y__h732 ;
  assign mac3__h542 =
	     _0_CONCAT_mac_inputs_rv_port0__read_BITS_95_TO__ETC___d11[15:0] +
	     y__h562 ;
  assign x__h563 = { 8'd0, mac_inputs_rv[95:88] } ;
  assign x__h733 = { 8'd0, mac_inputs_rv[87:80] } ;
  assign x__h820 = { 8'd0, mac_inputs_rv[79:72] } ;
  assign x__h907 = { 8'd0, mac_inputs_rv[71:64] } ;
  assign y__h562 = { 8'd0, mac_inputs_rv[31:24] } ;
  assign y__h564 = { 8'd0, mac_inputs_rv[63:56] } ;
  assign y__h732 = { 8'd0, mac_inputs_rv[23:16] } ;
  assign y__h734 = { 8'd0, mac_inputs_rv[55:48] } ;
  assign y__h819 = { 8'd0, mac_inputs_rv[15:8] } ;
  assign y__h821 = { 8'd0, mac_inputs_rv[47:40] } ;
  assign y__h906 = { 8'd0, mac_inputs_rv[7:0] } ;
  assign y__h908 = { 8'd0, mac_inputs_rv[39:32] } ;
