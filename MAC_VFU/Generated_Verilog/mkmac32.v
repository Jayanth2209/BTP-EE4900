...
//
// On Mon Mar 27 02:37:42 IST 2023
//
//
// Ports:
// Name                         I/O  size props
...
// CLK                            I     1 clock
// RST_N                          I     1 reset
// get_values_multiplicand1       I    32 reg
// get_values_multiplicand2       I    32 reg
// get_values_addend              I    32 reg
// EN_get_values                  I     1
//
...
module mkmac32(CLK,
  ...
  wire CAN_FIRE_RL_compute_mac32,
       CAN_FIRE_get_values,
       WILL_FIRE_RL_compute_mac32,
       WILL_FIRE_get_values;

  // remaining internal signals
  wire [127 : 0] _0_CONCAT_m1_MUL_0_CONCAT_m2___d7;
  wire [63 : 0] x__h250, y__h249, y__h251;
  ...
  // rule RL_compute_mac32
  assign CAN_FIRE_RL_compute_mac32 = isReady == 2'd1 ;
  assign WILL_FIRE_RL_compute_mac32 = CAN_FIRE_RL_compute_mac32 ;
  ...
  assign isReady$EN = EN_get_values || WILL_FIRE_RL_compute_mac32 ;
  ...
  // register resmac
  assign resmac$D_IN = _0_CONCAT_m1_MUL_0_CONCAT_m2___d7[63:0] + y__h249 ;
  assign resmac$EN = CAN_FIRE_RL_compute_mac32 ;

  // remaining internal signals
  assign _0_CONCAT_m1_MUL_0_CONCAT_m2___d7 = x__h250 * y__h251 ;
  assign x__h250 = { 32'd0, m1 } ;
  assign y__h249 = { 32'd0, a } ;
  assign y__h251 = { 32'd0, m2 } ;
  ...
  begin
	...
	resmac <= `BSV_ASSIGNMENT_DELAY 64'd0;
      end
    else
      begin
